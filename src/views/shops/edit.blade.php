@extends('pulsar::layouts.tab', ['tabs' => [['id' => 'box_tab1', 'name' => trans_choice('octopus::pulsar.shop', 1)], ['id' => 'box_tab2', 'name' => trans_choice('pulsar::pulsar.address', 2)]]])
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if ($.fn.dataTable)
            {
                ...
                {
                    $('[name="urlTarget"]').val('{{ route('editOctopusShop', ['id' => $object->id_076]) }}/' + settings._iDisplayStart + '/0');
                });
            }
