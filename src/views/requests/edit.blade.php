...
@section('rows')
    ...
    <div class="row">
        <div class="col-md-6">
            @include('pulsar::includes.html.form_text_group', ['label' => trans_choice('pulsar::pulsar.date', 1), 'name' => 'date', 'readOnly' => true, 'value' => date('d-m-Y', $object->date_078), 'maxLength' => '100', 'rangeLength' => '2,100', 'fieldSize' => 4])
