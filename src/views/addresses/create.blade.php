...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans('pulsar::pulsar.alias'), 'name' => 'alias', 'value' => old('alias'), 'maxLength' => '100', 'rangeLength' => '2,100'])
    ...
    @include('pulsar::includes.html.form_checkbox_group', ['label' => trans('pulsar::pulsar.favorite'), 'name' => 'favorite', 'value' => 1, 'checked' => old('favorite')])
