...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans_choice('pulsar::pulsar.business', 1), 'name' => 'business', 'value' => Input::old('business'), 'maxLength' => '100', 'rangeLength' => '2,100'])
