        <li{!! Miscellaneous::setCurrentOpenPage(['octopus-family','octopus-brand','octopus-product','octopus-laboratory','octopus-company','octopus-customer','octopus-shop','octopus-request','octopus-order', 'octopus-preference']) !!}>
            ...
            <ul class="sub-menu">
                ...
                @endif
                @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'mifinan', 'access'))
                    <li{!! Miscellaneous::setCurrentPage('octopus-order') !!}><a href="{{ route('OctopusOrder') }}"><i class="icon-refresh"></i>{{ trans_choice('octopus::pulsar.order', 2) }}</a></li>
                @endif
                @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-request', 'access'))
                ...
                <li{!! Miscellaneous::setCurrentOpenPage(['octopus-family','octopus-brand','octopus-product','octopus-laboratory','octopus-company','octopus-customer','octopus-shop', 'octopus-preference']) !!}>
                    ...
                    <ul class="sub-menu">
                        ...
                        @endif
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-customer', 'access'))
                        ...
                        @endif
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-company', 'access'))
                        ...
                        @endif
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-laboratory', 'access'))
                        ...
                        @endif
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-product', 'access'))
                        ...
                        @endif
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-brand', 'access'))
                        ...
                        @endif
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'octopus-family', 'access'))
                        ...
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'forms-preference', 'access'))
                            <li{!! Miscellaneous::setCurrentPage('octopus-preference') !!}><a href="{{ route('OctopusPreference') }}"><i class="icon-cog"></i>{{ trans_choice('pulsar::pulsar.preference', 2) }}</a></li>
                        @endif
                    </ul>
                </li>
            </ul>
