...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans_choice('octopus::pulsar.brand', 1), 'name' => 'brand', 'value' => old('brand'), 'required' => true, 'objects' => $brands, 'idSelect' => 'id_071', 'nameSelect' => 'name_071'])
