...
class CustomerController extends Controller
{
    ...
    public function storeCustomRecord($parameters)
    {
        Customer::create([
            ...
            'country_id_075'            => $this->request->input('country'),
            'territorial_area_1_id_075' => $this->request->has('territorialArea1')? $this->request->input('territorialArea1') : null,
            'territorial_area_2_id_075' => $this->request->has('territorialArea2')? $this->request->input('territorialArea2') : null,
            'territorial_area_3_id_075' => $this->request->has('territorialArea3')? $this->request->input('territorialArea3') : null,
