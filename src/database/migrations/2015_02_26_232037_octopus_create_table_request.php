...
class OctopusCreateTableRequest extends Migration {
	...
	public function up()
	{
        Schema::create('008_078_request', function($table)
        {
            ...
            $table->foreign('supervisor_078')->references('id_010')
                ->on('001_010_user')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('customer_078')->references('id_075')->on('008_075_customer')
                ->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('shop_078')->references('id_076')->on('008_076_shop')
                ->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('company_078')->references('id_074')
                ->on('008_074_company')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('family_078')->references('id_070')
                ->on('008_070_family')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('brand_078')->references('id_071')
            ...
            $table->foreign('territorial_area_1_078')->references('id_003')->on('001_003_territorial_area_1')
                ->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('territorial_area_2_078')->references('id_004')->on('001_004_territorial_area_2')
                ->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('territorial_area_3_078')->references('id_005')->on('001_005_territorial_area_3')
                ->onDelete('restrict')->onUpdate('cascade');
        });
	}
