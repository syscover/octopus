	...
	public function up()
	{
        if(! Schema::hasTable('008_077_address'))
        {
            Schema::create('008_077_address', function ($table) {
                ...
                $table->foreign('shop_id_077', 'fk01_008_077_address')
                    ->references('id_076')
                    ->on('008_076_shop')
                    ->onDelete('cascade')
                    ->onUpdate('cascade');
                $table->foreign('country_id_077', 'fk02_008_077_address')
                    ->references('id_002')
                    ->on('001_002_country')
                    ->onDelete('restrict')
                    ->onUpdate('cascade');
                $table->foreign('territorial_area_1_id_077', 'fk03_008_077_address')
                    ->references('id_003')
                    ->on('001_003_territorial_area_1')
                    ->onDelete('restrict')
                    ->onUpdate('cascade');
                $table->foreign('territorial_area_2_id_077', 'fk04_008_077_address')
                    ->references('id_004')
                    ->on('001_004_territorial_area_2')
                    ->onDelete('restrict')
                    ->onUpdate('cascade');
                $table->foreign('territorial_area_3_id_077', 'fk05_008_077_address')
                    ->references('id_005')
