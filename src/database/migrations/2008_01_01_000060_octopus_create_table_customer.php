	...
	public function up()
	{
        if(! Schema::hasTable('008_075_customer'))
        {
            Schema::create('008_075_customer', function ($table) {
                ...
                $table->foreign('country_id_075', 'fk01_008_075_customer')
                    ->references('id_002')
                    ->on('001_002_country')
                    ->onDelete('restrict')
                    ->onUpdate('cascade');
                $table->foreign('territorial_area_1_id_075', 'fk02_008_075_customer')
                    ->references('id_003')
                    ->on('001_003_territorial_area_1')
                    ->onDelete('restrict')
                    ->onUpdate('cascade');
                $table->foreign('territorial_area_2_id_075', 'fk03_008_075_customer')
                    ->references('id_004')
                    ->on('001_004_territorial_area_2')
                    ->onDelete('restrict')
                    ->onUpdate('cascade');
                $table->foreign('territorial_area_3_id_075', 'fk04_008_075_customer')
                    ->references('id_005')
