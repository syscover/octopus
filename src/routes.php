...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/octopus/address/modal/{ref}/{modal}/{offset?}',                     ['as'=>'octopusAddress',                    'uses'=>'Syscover\Octopus\Controllers\AddressController@index',                           'resource' => 'octopus-address',        'action' => 'access']);
    ...
    Route::get(config('pulsar.appName') . '/octopus/address/create/{ref}/{offset}/{tab}/{modal}',               ['as'=>'createOctopusAddress',              'uses'=>'Syscover\Octopus\Controllers\AddressController@createRecord',                    'resource' => 'octopus-address',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/octopus/address/store/{ref}/{offset}/{tab}/{modal}',               ['as'=>'storeOctopusAddress',               'uses'=>'Syscover\Octopus\Controllers\AddressController@storeRecord',                     'resource' => 'octopus-address',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/octopus/address/{ref}/{id}/edit/{offset}/{tab}/{modal}',            ['as'=>'editOctopusAddress',                'uses'=>'Syscover\Octopus\Controllers\AddressController@editRecord',                      'resource' => 'octopus-address',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/octopus/address/update/{id}/{offset}/{tab}/{modal}',                ['as'=>'updateOctopusAddress',              'uses'=>'Syscover\Octopus\Controllers\AddressController@updateRecord',                    'resource' => 'octopus-address',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/octopus/address/delete/{id}/{ref}/{offset}/{tab}/{modal}',          ['as'=>'deleteOctopusAddress',              'uses'=>'Syscover\Octopus\Controllers\AddressController@deleteRecord',                    'resource' => 'octopus-address',        'action' => 'delete']);
