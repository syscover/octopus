...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/octopus/stock/{id}/show/{offset}',                   ['as' => 'showOctopusStock',                  'uses' => 'Syscover\Octopus\Controllers\StockController@showRecord',                'resource' => 'octopus-stock',       'action' => 'access']);
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/octopus/supervisor/stock/{id}/show/{offset}',                   ['as' => 'showOctopusSupervisorStock',                  'uses' => 'Syscover\Octopus\Controllers\StockController@showRecord',                'resource' => 'octopus-supervisor-stock',       'action' => 'access']);
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/octopus/order/{id}/show/{offset}',                   ['as' => 'showOctopusOrder',                  'uses' => 'Syscover\Octopus\Controllers\OrderController@showRecord',                'resource' => 'octopus-order',       'action' => 'access']);
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/octopus/laboratory/order/{id}/show/{offset}',                   ['as' => 'showOctopusLaboratoryOrder',                  'uses' => 'Syscover\Octopus\Controllers\OrderController@showRecord',                'resource' => 'octopus-laboratory-order',       'action' => 'access']);
