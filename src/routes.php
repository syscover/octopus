...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/octopus/laboratory/order/{id}/show/{offset}',                   ['as' => 'showOctopusLaboratoryOrder',                  'uses' => 'Syscover\Octopus\Controllers\OrderController@showRecord',                'resource' => 'octopus-laboratory-stock',       'action' => 'access']);
